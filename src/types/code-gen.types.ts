...
export type BoxTransactionTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["BoxTransactionType"] = ResolversParentTypes["BoxTransactionType"]
> = {
  attachment?: Resolver<
  ...
  totalValue?: Resolver<
    ResolversTypes["CurrencyType"],
    ParentType,
    ContextType
  >;
  transactionCalculations?: Resolver<
    Array<ResolversTypes["TransactionCalculationType"]>,
    ParentType,
    ContextType
  >;
  transactionStatus?: Resolver<
    ResolversTypes["TransactionStatusEnum"],
    ParentType,
    ContextType
  >;
  transactionType?: Resolver<
    ResolversTypes["TransactionTypeEnum"],
    ParentType,
    ContextType
  >;
...
export type BudgetBoxCurrencyTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["BudgetBoxCurrencyType"] = ResolversParentTypes["BudgetBoxCurrencyType"]
> = {
  currency?: Resolver<
    ResolversTypes["BudgetBoxCurrencies"],
    ParentType,
    ContextType
  >;
...
export type BudgetBoxTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["BudgetBoxType"] = ResolversParentTypes["BudgetBoxType"]
> = {
  balanceAvailable?: Resolver<
    ResolversTypes["BudgetBoxCurrencyType"],
    ParentType,
    ContextType
  >;
  ...
  reasons?: Resolver<
    Array<ResolversTypes["ReasonType"]>,
    ParentType,
    ContextType
  >;
  updatedAt?: Resolver<ResolversTypes["DateTime"], ParentType, ContextType>;
...
export type CurrencyTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["CurrencyType"] = ResolversParentTypes["CurrencyType"]
> = {
  currency?: Resolver<
    ResolversTypes["TransactionCurrencies"],
    ParentType,
    ContextType
  >;
  value?: Resolver<ResolversTypes["Float"], ParentType, ContextType>;
...
export type JwtPayloadTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["JwtPayloadType"] = ResolversParentTypes["JwtPayloadType"]
> = {
...
> = {
  addReasonToBudgetBox?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationAddReasonToBudgetBoxArgs, "AddReasonToBudgetBoxInput">
  >;
  changeBudgetName?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationChangeBudgetNameArgs, "ChangeBudgetBoxNameInput">
  >;
  changeBudgetPercentage?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<
    ...
    >
  >;
  changeReasonDescription?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<
    ...
    >
  >;
  createBudgetBox?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationCreateBudgetBoxArgs, "CreateBudgetBoxInput">
  >;
  createExpense?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationCreateExpenseArgs, "CreateExpenseInput">
  >;
  deleteBudgetBox?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteBudgetBoxArgs, "DeleteBudgetBoxInput">
  >;
  deleteUserAccount?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationDeleteUserAccountArgs, "DeleteUserAccountInput">
  >;
  percentageCapitalInflowPosting?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<
      MutationPercentageCapitalInflowPostingArgs,
      "PercentageCapitalInflowPostingInput"
    >
  >;
  postingToBenefit?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationPostingToBenefitArgs, "PostingToBenefitInput">
  >;
  removeReasonFromBudgetBox?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<
  ...
  signup?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationSignupArgs, "SignupInput">
  >;
  transferBalance?: Resolver<
    ResolversTypes["Boolean"],
    ParentType,
    ContextType,
    RequireFields<MutationTransferBalanceArgs, "BalanceTransferenceInput">
  >;
};
...
> = {
  getBudgetBoxById?: Resolver<
    ResolversTypes["BudgetBoxType"],
    ParentType,
    ContextType,
    RequireFields<QueryGetBudgetBoxByIdArgs, "GetBudgetBoxByIdInput">
  >;
  getBudgetBoxes?: Resolver<
    Array<ResolversTypes["BudgetBoxType"]>,
    ParentType,
    ContextType
  >;
  getTransactionById?: Resolver<
    ResolversTypes["BoxTransactionType"],
    ParentType,
    ContextType,
    RequireFields<QueryGetTransactionByIdArgs, "GetTransactionByIdInput">
  >;
  getTransactions?: Resolver<
    Array<ResolversTypes["BoxTransactionType"]>,
    ParentType,
    ContextType
  >;
...
export type ReasonTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["ReasonType"] = ResolversParentTypes["ReasonType"]
> = {
  createdAt?: Resolver<ResolversTypes["DateTime"], ParentType, ContextType>;
  description?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
...
export type TermTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["TermType"] = ResolversParentTypes["TermType"]
> = {
  acceptedAt?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  ip?: Resolver<ResolversTypes["String"], ParentType, ContextType>;
  userAgent?: Resolver<
    ResolversTypes["UserAgentType"],
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
...
export type TransactionCalculationTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["TransactionCalculationType"] = ResolversParentTypes["TransactionCalculationType"]
> = {
...
export type UserAgentTypeResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["UserAgentType"] = ResolversParentTypes["UserAgentType"]
> = {
...
> = {
  ...
  id?: Resolver<ResolversTypes["ID"], ParentType, ContextType>;
  terms?: Resolver<
    Maybe<Array<ResolversTypes["TermType"]>>,
    ParentType,
    ContextType
  >;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
